    ...
    const handleProcessSplitCheckout = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/orders/`, {
                ...
                shipping_rt_rw: selectedAddress?.rt_rw || selectedAddress?.address_rt_rw || addresses?.address_rt_rw || '',
                ...
                shipping_postal_code: selectedAddress?.kode_pos || selectedAddress?.address_postal_code || addresses?.address_postal_code || '',
