        ...
        return (
            <div className={wrapperClass} ref={containerRef}>
                {[...Array(5)].map((_, i) => (
                    <div
                        key={i}
                        className="cloud absolute opacity-30 text-white"
                        style={{
                            top: `${10 + i * 20}%`,
                            left: '-10%',
        ...
        return (
            <div className={wrapperClass} ref={containerRef}>
                {[...Array(6)].map((_, i) => (
                    <div
                        key={i}
                        className={`animate-me absolute border-2 ${geoColor} opacity-20`}
                        style={{
        ...
        return (
            <div className={wrapperClass} ref={containerRef}>
                {[...Array(15)].map((_, i) => (
                    <div
                        key={i}
                        className="bubble absolute rounded-full bg-white/20 border border-white/30"
                        style={{
    ...
    if (decoration === 'islamic') {
        ...
        return (
            <div className={wrapperClass} ref={containerRef}>
                ...
                <div className={`lantern-float absolute top-10 left-[10%] w-10 h-14 ${goldColor}`}>
        ...
        return (
            <div className={wrapperClass} ref={containerRef}>
                {[...Array(10)].map((_, i) => (
                    <div
                        key={i}
                        className="float-icon absolute text-xl opacity-20"
        ...
        return (
            <div className={wrapperClass} ref={containerRef}>
                {[...Array(8)].map((_, i) => (
                    <div
                        key={i}
                        className="line-move absolute w-[200%] h-1 bg-white/10 rotate-[-45deg]"
