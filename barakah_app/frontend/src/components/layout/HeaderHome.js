...
const HeaderHome = ({ onSearch }) => {
  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-100" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex-1 max-w-[200px] mx-4">
            <input
              ...
              className="w-full px-4 py-2 border rounded-full text-sm focus:outline-none focus:ring-1 focus:ring-green-500"
            />
          </div>
