...
class Profile(models.Model):
    ...
    study_campus = models.CharField(max_length=300, blank=True, null=True)
    study_faculty = models.CharField(max_length=300, blank=True, null=True)
    study_department = models.CharField(max_length=300, blank=True, null=True)
    study_program = models.CharField(max_length=300, blank=True, null=True)
    ...
    work_institution = models.CharField(max_length=300, blank=True, null=True)
    work_position = models.CharField(max_length=300, blank=True, null=True)
    ...
    address_province = models.CharField(max_length=300, blank=True, null=True)
    ...
    address_city_name = models.CharField(max_length=300, blank=True, null=True)
    ...
    referred_by = models.CharField(max_length=300, blank=True, null=True, help_text="Nama orang yang mengajak")
