...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('user', 'order_number', 'total_price', 'status', 'shipping_type', 'resi_number', 'driver_name', 'paid_to_seller_directly', 'created_at')
    list_filter = ('user', 'status', 'shipping_type', 'paid_to_seller_directly')
    search_fields = ('user__username', 'order_number', 'resi_number', 'driver_name', 'driver_phone', 'seller_bank_holder', 'seller_bank_account')
